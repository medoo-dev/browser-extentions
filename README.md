...
**Have fun building!** 🚀
"# browser-extentions"  git init git add README.md git commit -m "first commit" git branch -M main git remote add origin git@github.com:medoo-dev/browser-extentions.git git push -u origin main
"# browser-extentions" 
